...
import face_rec  # ton module Redis personnalisé
import pandas as pd  # nécessaire pour DataFrame
...
# Onglet 2: Logs d'attendance
with tab2:
    if st.button('Refresh Logs'):
        st.write(load_logs(name=name))

# Onglet 3: Rapport de présence
with tab3:
    ...
    # Ajout d'une colonne "Absent" juste pour visualisation (non fonctionnelle)
    report_df['Absent'] = ''  # ou utilisez '✔️' / '❌' pour affichage symbolique
